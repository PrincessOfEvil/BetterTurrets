...
namespace WeaponBase
    ...
    public class Projectile_ThingSpawner : Bullet
        {
        public ThingDef_ThingSpawner Def => this.def as ThingDef_ThingSpawner;
        ...
        protected override void Impact(Thing hitThing, bool blockedByShield = false)
            ...
            RCellFinder.TryFindRandomCellNearWith(base.Position, ((IntVec3 x) =>
                                                      x.GetTerrain(map).affordances
                                                       .Contains(TerrainAffordanceDefOf.Light) &&
                                                      x.GetEdifice(map) == null && x.Standable(map)),
                                                  map, out IntVec3 cell, 2);
